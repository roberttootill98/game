...
async function cardSlot_filled_startDrag(ev) {
  ...
  currently_dragged_cardSlot_target = document.querySelectorAll('.container_companion')[parseInt(cardSlot.svg.id - 1) / 4 >> 0];
  ...
  const cardObj = new Card_Arrangement(currently_dragged_cardSlot_card.name, cardAttributes.width, cardAttributes.height,
